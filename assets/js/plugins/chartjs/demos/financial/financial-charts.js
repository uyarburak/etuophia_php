...
/**********************************
Stock Finacial Charts
**********************************/

var StockFinacialChartdataSource = [
...
$("#StockFinacialChart").dxChart({
    dataSource: StockFinacialChartdataSource,
...
var CandleStickChartdataSource = [
    { date: new Date(1994,2,1), l: 24.00, h: 25.00, o: 25.00, c: 24.875 },
	{ date: new Date(1994,2,2), l: 23.625, h: 25.125, o: 24.00, c: 24.875 },
	{ date: new Date(1994,2,3), l: 26.25, h: 28.25, o: 26.75, c: 27.00 },
	{ date: new Date(1994,2,4), l: 26.50, h: 27.875, o: 26.875, c: 27.25 },
...
$("#CandleStickChart").dxChart({
    title: "Stock Price",
    dataSource: CandleStickChartdataSource,
    commonSeriesSettings: {
        argumentField: "date",
        type: "candlestick"
    },
