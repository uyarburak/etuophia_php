...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colors: ['#30abe0','#F06060','#66c88d','#f06060','#f56f2b','#30abe0','#c180e6','#ec2f87','#C180E6'],
			...
			dotInnerColor: "#FFF", // only used for lineDots:'double'
			lineMargin: 0, //for line and area - spacing around lines
			barGroupMargin: 10,
			chartId: '',
