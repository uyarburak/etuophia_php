...
}if(!this.buttons){d=h.navButtons;var f=false;this.buttons=a('<ul class="pager"/>');this.buttons.addClass("bwizard-buttons");if(c!=""){this.backBtn=a("<li class='previous'><a href='#' class='btn btn-small gray-bg'>"+c+"</a></li>").appendTo(this.buttons).bind({click:function(){e.back();
return false;}}).attr("role","button");var f=true;}if(g!=""){this.nextBtn=a("<li class='next'><a href='#' class='btn btn-small blue-bg'>"+g+"</a>").appendTo(this.buttons).bind({click:function(){e.next();
